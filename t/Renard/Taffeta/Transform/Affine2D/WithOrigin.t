...
use Renard::Taffeta::Transform::Affine2D::WithOrigin;
use Renard::Taffeta::Transform::Affine2D::Rotation;
use Renard::Taffeta::Transform::Affine2D::Scaling;

subtest "Rotation" => sub {
	my $t = Renard::Taffeta::Transform::Affine2D::WithOrigin->new(
		affine2d => Renard::Taffeta::Transform::Affine2D::Rotation->new( angle => 45 ),
		origin => [1, 1],
	);
...
subtest "Scaling" => sub {
	my $scaling = Renard::Taffeta::Transform::Affine2D::Scaling->new( scale => [2, 2] );
	my $t = Renard::Taffeta::Transform::Affine2D::WithOrigin->new(
		affine2d => $scaling,
		origin => [-1, -1],
	);
